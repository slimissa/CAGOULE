"""conftest.py — Fixtures partagées CAGOULE v3.1.0
CORRECTIF v3.0.1 : les fixtures fast_params et c_backend_available ont été corrigées pour forcer une collision, et le test de performance a été amélioré pour mesurer le temps de 65k blocs (~1 MB) et vérifier le ratio inv/fwd.
"""
...
@pytest.fixture(scope="session")
def fast_params():
    """Paramètres rapides (Argon2id, coût réduit via fast_mode) pour les tests unitaires."""
